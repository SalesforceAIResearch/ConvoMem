...
/**
 * Short runners for TemporalEvidenceGenerator.
...
object GenerateTemporal1EvidenceShort {
  def main(args: Array[String]): Unit = {
    println("="*80)
    println("Running TemporalEvidenceGenerator in SHORT mode (1 evidence)")
    println("Output: short_runs/questions/evidence/temporal_evidence/1_evidence/")
    ...
    val generator = new TemporalEvidenceGenerator(1) {
...
object GenerateTemporal2EvidenceShort {
  def main(args: Array[String]): Unit = {
    println("="*80)
    println("Running TemporalEvidenceGenerator in SHORT mode (2 evidence)")
    println("Output: short_runs/questions/evidence/temporal_evidence/2_evidence/")
    println("Processing: 3 personas × 20 use cases = ~60 evidence items")
    println("IMPORTANT: Review all 20 use cases per person for diversity!")
    println("="*80)
    
    val generator = new TemporalEvidenceGenerator(2) {
      override val runShort: Boolean = true
    }
